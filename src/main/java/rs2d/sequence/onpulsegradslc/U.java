...
public enum U implements GeneratorParamEnum {
    ...
    CALIB_DELAY_BEFORE_GRAD("CALIB_DELAY_BEFORE_GRAD") {
        public Param build() {
            ...
            param.setCategory(Category.Acquisition);
            param.setUuid("b3a51bad-74be-4058-a15d-c930337da260");
            param.setNumberEnum(NumberEnum.Time);
    ...
    CALIB_GRAD_LENGTH_1("CALIB_GRAD_LENGTH_1") {
        public Param build() {
            ...
            param.setDisplayedName("Calib Grad Length 1");
            param.setDescription("");
            param.setGroup(EnumGroup.Delay);
            param.setCategory(Category.Acquisition);
            param.setUuid("cb0e22df-18a5-4686-b65a-1bd21f7f8c26");
            param.setNumberEnum(NumberEnum.Time);
            param.setMinValue(4.9999999999999996E-6);
            param.setMaxValue(1.0E9);
            param.setValue(0.12);
    ...
    CALIB_GRAD_LENGTH_2("CALIB_GRAD_LENGTH_2") {
        public Param build() {
            ...
            param.setGroup(EnumGroup.Delay);
            param.setCategory(Category.Acquisition);
            param.setUuid("17c952d1-a2af-4ba7-9ea2-47fc8ca957f9");
            param.setNumberEnum(NumberEnum.Time);
            param.setMinValue(4.9999999999999996E-6);
            param.setMaxValue(1.0E9);
    ...
    CALIB_GRAD_LENGTH_3("CALIB_GRAD_LENGTH_3") {
        public Param build() {
            ...
            param.setGroup(EnumGroup.Delay);
            param.setCategory(Category.Acquisition);
            param.setUuid("5f639be3-2ff9-4d02-9065-d2e5b41eec8a");
            param.setNumberEnum(NumberEnum.Time);
            param.setMinValue(0.0);
            param.setMaxValue(1.0E9);
    ...
    CALIB_GRAD_LENGTH_EFF_2("CALIB_GRAD_LENGTH_EFF_2") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(1.0E9);
            param.setValue(5.2130909090909096E-6);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    ECHO_TIME("ECHO_TIME") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(1.0E9);
            param.setValue(0.0039697687272727275);
    ...
    GMAX("GMAX") {
        public Param build() {
            ...
            param.setValue(0.11627249999999997);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    GRADIENT_REFOC_TIME("GRADIENT_REFOC_TIME") {
        public Param build() {
            ...
            param.setGroup(EnumGroup.Delay);
            param.setCategory(Category.Acquisition);
            param.setUuid("827972e2-a6fe-4b52-bed1-cdb0d0346c8a");
            param.setNumberEnum(NumberEnum.Time);
            param.setMinValue(0.0);
            param.setMaxValue(1.0E9);
    ...
    GRAD_CLOCK_NUMBER("GRAD_CLOCK_NUMBER") {
        public Param build() {
            NumberParam param = new NumberParam();
            param.setName("GRAD_CLOCK_NUMBER");
            param.setDisplayedName("Grad Clock Number (Hardware Limit)");
            param.setDescription("Grad clock number, 1 or 11");
            param.setGroup(EnumGroup.Gradient);
            param.setCategory(Category.Acquisition);
            param.setUuid("fc5230f7-4f51-4580-9a45-04f6c78eb459");
            param.setNumberEnum(NumberEnum.Integer);
            param.setMinValue(-2147483648);
            param.setMaxValue(2147483647);
            param.setValue(1);
            param.setDefaultValue(1);
            param.setSuggestedValues(asListNumber(1, 11));
            param.setRestrictedToSuggested(true);
            return param;
        }
    },

    GRAD_MAX_SEQUENCE("GRAD_MAX_SEQUENCE") {
        public Param build() {
            NumberParam param = new NumberParam();
            param.setName("GRAD_MAX_SEQUENCE");
            param.setDisplayedName("Grad Max");
            param.setDescription("Maximum gradient amplitude applied in the sequence (%)");
            param.setGroup(EnumGroup.Gradient);
            param.setCategory(Category.Acquisition);
            param.setUuid("7919f98f-86fa-4e6a-9b75-f5446dd4fe6b");
            param.setNumberEnum(NumberEnum.GradAmp);
            param.setMinValue(-100.0);
            param.setMaxValue(100.0);
            param.setValue(40.0);
    ...
    SEQUENCE_NAME("SEQUENCE_NAME") {
        public Param build() {
            ...
            param.setValue("OnePulse_Grad_Slc");
    ...
    SPECTRAL_WIDTH("SPECTRAL_WIDTH") {
        public Param build() {
            ...
            param.setValue(124007.93650793652);
    ...
    SPECTRAL_WIDTH_PER_PIXEL("SPECTRAL_WIDTH_PER_PIXEL") {
        public Param build() {
            ...
            param.setValue(7.568843781001985);
    ...
    TX_AMP("TX_AMP") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(100.0);
            param.setValue(4.601193307807356);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    TX_LENGTH("TX_LENGTH") {
        public Param build() {
            ...
            param.setValue(0.0020070400000000003);
