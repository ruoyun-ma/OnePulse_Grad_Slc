...
public enum U implements GeneratorParamEnum {
    ...
    CALIB_GRAD_LENGTH_EFF_1("CALIB_GRAD_LENGTH_EFF_1") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(1.0E9);
            param.setValue(0.12002099200000002);
            param.setDefaultValue(0.0);
            return param;
        }
    },
    ...
    CALIB_LOCATIONS("CALIB_LOCATIONS") {
        public Param build() {
            ...
            param.setValue(asListNumber(0.012, 0.006, -0.006, -0.012));
    ...
    REPETITION_TIME("REPETITION_TIME") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(1.0E9);
            param.setValue(0.7000908640000001);
    ...
    TX_AMP("TX_AMP") {
        public Param build() {
            ...
            param.setMinValue(0.0);
            param.setMaxValue(100.0);
            param.setValue(0.9475169456984012);
            param.setDefaultValue(0.0);
            return param;
        }
    },
